...
public class Simulator {
    ...
    public static void main(String[] args) throws IOException {
        int NF = 4, NQ = 8, ND = 4, NI = 8, NW = 4, NR = 16, NC = 4, NB = 4;
        if(args.length < 1) {
        ...
        if(dumpRegs){
            System.out.println(intRegisters.toSubmissionString("INT_REG"));
            System.out.println(floatRegisters.toSubmissionString("FLOAT_REG"));
        }
        if(dumpMem){
            for(Map.Entry entry: memory.entrySet()){
        ...
        if(dumpBT){
            ...
            System.out.println("Index Instruction addresses   Target Addresses    Predictions");
            ...
            for(int b =0 ;b<32;b++){
                ...
                if(outcomes[b])
                    ...
                    taken="Not Taken";
                System.out.println(b + ": " + instructionAddresses[b]+"    "+convertedAdd+"  "+taken);
            }
        }
    }
